...
const NONTERMINAL &getNonterminal(const RightAssociate &l)
{
    return get<NONTERMINAL>(l.second);
}

const TERMINAL &getTerminal(const RightAssociate &l)
{
    return get<TERMINAL>(l.second);
}
