...
namespace std
{
    ...
    public:
        ...
        vector<shared_ptr<TERMINALTYPE>> getFirst() const;
    ...
    public:
        ...
        vector<shared_ptr<TERMINALTYPE>> getFirst() const
        {
            return vector<shared_ptr<TERMINALTYPE>>{*this};
        }
    ...
    public:
        ...
        HANDLERULE getHandleRule() const;
        vector<shared_ptr<TERMINALTYPE>> getFirst() const;
    ...
    public:
        ...
        const shared_ptr<NONTERMINALTYPE> &getNonterminal() const;
        const shared_ptr<TERMINALTYPE> &getTerminal() const;
